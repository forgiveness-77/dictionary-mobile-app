...
// Search input (icon inside, focus ring) + full-width Search button, matching
// the LexiTech home design. Shows inline validation feedback.
  ...
  return (
    <View>
      <View
        style={[
          styles.inputWrap,
          active && styles.inputWrapActive,
          showError && styles.inputWrapError,
        ]}
      >
        <SearchIcon
          size={22}
          color={showError ? colors.error : active ? colors.primary : colors.outline}
        />
        <TextInput
          style={styles.input}
          value={value}
